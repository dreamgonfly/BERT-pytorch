...
detect_sentences_parser.add_argument('sentences_detected_path', nargs='?', type=str, default='sentences_detected.txt')
...
prepare_documents_parser.add_argument('prepared_documents_path', nargs='?', type=str, default='prepared_documents.txt')
